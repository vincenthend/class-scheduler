...
// CREATE LECTURE "ML" TAUGHT BY "Dessi" FOR 100 STUDENTS REQUIRING "PROJECTOR";
...
// CREATE LECTURER "Dessi" AVAILABLE AT MONDAY FROM 7 UNTIL 10, WEDNESDAY FROM 12 UNTIL 13;
